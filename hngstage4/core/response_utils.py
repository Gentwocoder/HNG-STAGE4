...
class APIResponse:
    ...
    def unauthorized(error: str = "Unauthorized access") -> Response:
        ...
        return APIResponse.error(
            error=error, message="Authentication required", status_code=status.HTTP_401_UNAUTHORIZED
        )
    ...
    def forbidden(error: str = "Access forbidden") -> Response:
        ...
        return APIResponse.error(
            error=error, message="Permission denied", status_code=status.HTTP_403_FORBIDDEN
        )
    ...
    def not_found(error: str = "Resource not found") -> Response:
        ...
        return APIResponse.error(
            error=error, message="Not found", status_code=status.HTTP_404_NOT_FOUND
        )
    ...
    def server_error(error: str = "Internal server error") -> Response:
        ...
        return APIResponse.error(
            error=error, message="Server error", status_code=status.HTTP_500_INTERNAL_SERVER_ERROR
        )
