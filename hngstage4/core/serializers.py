...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'avatar_url', 'timezone', 'language', 'bio',
...
class NotificationPreferenceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'email_enabled', 'email_marketing', 'email_transactional',
            'email_security', 'email_system', 'push_enabled', 'push_marketing',
            'push_transactional', 'push_security', 'push_system',
            'do_not_disturb_start', 'do_not_disturb_end', 'frequency_limit',
            'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
...
class PushTokenSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PushToken
        fields = [
            'id', 'token', 'token_type', 'platform', 'device_id',
            'device_name', 'is_active', 'last_used', 'created_at', 'updated_at'
        ]
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'profile', 'notification_preferences', 'push_tokens_count'
        ]
        read_only_fields = [
            'id', 'is_verified', 'created_at', 'updated_at', 'last_login'
        ]
